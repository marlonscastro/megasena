...
int main(int argv, char *argc[])
{
    ...
    int i, j, k;
    int *numeros;
    int num[6] = {0,0,0,0,0,0}, num1[6] = {0,0,0,0,0,0}, num2[6] = {0,0,0,0,0,0}, num3[6] = {0,0,0,0,0,0}, num4[6] = {0,0,0,0,0,0};
    ...
    strcat(fileName, "CompQUATROJogosAnteriores.txt");
    f = fopen(fileName, "w");
    if(!f){
    ...
    for(i = 1; i <= 1888; i++){
        ...
        numeros = getNumerosMega(i+3);
        for(j=0;j<6;j++) num3[j] = numeros[j];
        numeros = getNumerosMega(i+4);
        for(j=0;j<6;j++) num4[j] = numeros[j];

        printf("analisando jogo %04d | %02d - %02d - %02d - %02d - %02d - %02d", i+4, num4[0], num4[1], num4[2], num4[3], num4[4], num4[5]);
        fprintf(f, "analisando jogo %04d | %02d - %02d - %02d - %02d - %02d - %02d", i+4, num4[0], num4[1], num4[2], num4[3], num4[4], num4[5]);
        contNum = 0;
        total = 0;
        for(j = 0; j < 6; j++){
            for(k = 0;k < 6;k++){
                if(num4[j]==num3[k]){
                    ocorr[contNum++] = num4[j];
                }
                if(num4[j]==num2[k]){
                    ocorr[contNum++] = num4[j];
                }
