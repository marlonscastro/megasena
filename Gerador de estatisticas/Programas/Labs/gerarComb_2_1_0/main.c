...
int main()
{
    ...
    /* Tabela de Parametros, serve para passar ao sistema como os jogos serão gerados 
        +      :     Quantidade de Dezenas da faixa MAIS (vetor mais[15])
        .      :     Quantidade de Dezenas da faixa COMUNS (vetor Comuns[30])
        -      :     Quantidade de Dezenas da faixa MENOS (vetor menos[15])
        Par    :     Quantidade de Ocorrencia de PARES na Sequência
        <31    :     Quantidade de Dezenas Abaixo de 31 na Sequência 
        proporção    :  Informa a Proporção de Numeros gerados em relação ao total de Dezenas
                        é expressa em porcentagem, ex: 19%
    */
    ...
    printf("INVESTIMENTO NECESSARIO: Quant: %d;R$ %1.2f\n", contGeral, (float)(contGeral*98.0));
    fclose(f);
}
